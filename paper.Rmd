...
\caption{Schematic diagram showing the calculation of the orthogonal distance (left) and the slice through a 3D sphere (right). We show both a slice centered at the origin (green) and one with a different centering around $\mathbf{c}$.}
\label{fig:diagrams}
\end{figure*}
