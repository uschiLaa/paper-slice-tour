...
The paper was written in `rmarkdown` [@rmarkdown] using `knitr` [@knitr]. The source material for this paper are available at \url{https://github.com/uschiLaa/paper-slice-tour} and animated gifs can be found at \url{https://uschilaa.github.io/paper-slice-tour/}.
