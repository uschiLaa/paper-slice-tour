...
\noindent and $\mathbf{x}_i, i=1,...,n$ a $p$-dimensional observation in $\mathbf{X}$ and $\mathbf{a}_i, i=1,2$ denoting the columns of the projection matrix, $\mathbf{A}=(\mathbf{a}_1, \mathbf{a}_2)$.
