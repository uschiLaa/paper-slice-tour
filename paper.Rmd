...
To demonstrate the slice tour we sample points on the surface of a sphere with radius $r=1$ in $p=3$ and $p=5$ dimensions. We use the `geozoo` package [@geozoo] to draw 2000 (5000) points on the 3d (5d) sphere.
