...
Using the `geozoo` package [@geozoo] a number of ideal shapes are generated. \textcolor{red}{Here we show selected slices, slice tour animations for all examples are available at \url{https://github.com/uschiLaa/paper-slice-tour}.}
