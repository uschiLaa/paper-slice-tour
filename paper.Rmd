...
\centerline{\includegraphics[width=0.2\textwidth]{gifs/png/sphere-5-anchored-014.png}
\hspace{5mm}
\includegraphics[width=0.2\textwidth]{gifs/png/sphere-5-anchored-010.png}
\hspace{5mm}
\includegraphics[width=0.2\textwidth]{gifs/png/sphere-5-anchored-001.png}}
...
Selected views from a slice tour of the scaled and centered data, and with large slice volume $\epsilon = 0.15$ are shown in the first row of Figure \ref{fig:wine}. The slices allow to clearly see the non-linearity of the boundary between the green and orange group. The first view also shows a non-linear boundary of the purple group. Interestingly this group does not appear at all in the second slice shown here. For comparison we show projections onto the same planes in the second row of Figure \ref{fig:wine}, showing how the observed features can be hidden by overplotting.
...
\centerline{\includegraphics[width=0.2\textwidth]{gifs/png/wine-projected-029.png}
\hspace{5mm}
\includegraphics[width=0.2\textwidth]{gifs/png/wine-projected-042.png}
\hspace{5mm}
\includegraphics[width=0.2\textwidth]{gifs/png/wine-projected-049.png}
\hspace{5mm}
\includegraphics[width=0.2\textwidth]{gifs/png/wine-projected-100.png}}
\caption{Different slices (first row) and projections (second row) of the wine dataset .}
\label{fig:wine}
\end{figure*}
...
In this note we introduce a new visualization method for dynamic slicing of high-dimensional parameter spaces. It is based on interpolated projections obtained in a grand tour and generates an interpolated sequence of sliced projections. The examples shown in Section XXX demonstrate the potential of this new display to find and explore concave structures, as well as other hidden features.
